...
const float S_WIDTH = 800.f;
const float S_HEIGHT = 600.f;
...
mMesh(
  std::vector<Vertex> ({
    ...
    { .position = { -0.5f, -(S_HEIGHT / S_WIDTH / 2.f), 0.f }, .normal = mNormal, .texCoords = { 1.f, 0.f } },
    { .position = {  0.5f, -(S_HEIGHT / S_WIDTH / 2.f), 0.f }, .normal = mNormal, .texCoords = { 0.f, 0.f } },
    { .position = {  0.5f,  (S_HEIGHT / S_WIDTH / 2.f), 0.f }, .normal = mNormal, .texCoords = { 0.f, 1.f } },
    { .position = { -0.5f,  (S_HEIGHT / S_WIDTH / 2.f), 0.f }, .normal = mNormal, .texCoords = { 1.f, 1.f } }
  }),
